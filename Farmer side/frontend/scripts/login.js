...
function getRedirectPath(pageName) {
  if (window.location.pathname.includes('frontend/pages') || window.location.pathname.includes('frountend/pages')) {
    return pageName; // relative from frountend/pages/
  }
  return 'frontend/pages/' + pageName; // from root or other
}
